/******/ (() => {
    ...
    support
      ...
      `;
		...
		core.use([Navigation, Pagination, freeMode]);
		const swiperEl = document.querySelector(".cast__slider");
		const castSlider = new core(swiperEl, {
			pagination: {
				el: ".swiper-pagination",
				type: "progressbar",
			},
		...
		// EXTERNAL MODULE: ./src/js/components/more-images.js
		var more_images = __webpack_require__(227);
		// EXTERNAL MODULE: ./src/js/components/map.js
		var map = __webpack_require__(283); // CONCATENATED MODULE: ./src/js/_components.js // CONCATENATED MODULE: ./src/js/main.js
	})();
